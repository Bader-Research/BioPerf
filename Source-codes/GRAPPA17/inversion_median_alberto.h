...
void init_global_variables(int);
void genome_init();
void median_init();
...
int* albert_inversion_median_circular(struct genome_struct **gen, int ngenes, int* genes);
int* albert_inversion_median_noncircular(struct genome_struct **gen, int ngenes, int* genes);
