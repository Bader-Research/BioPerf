...
/* $Name: fa34t25d2 $ - $Id: dropfz2.c,v 1.38 2005/02/12 20:07:17 wrp Exp $ */
...
#ifndef ALLOCN0
static char *verstr="3.48 March 2004";
#else
static char *verstr="3.48an0 Marc 2004";
#endif
	    ...
	    struct f_struct *f_str)
{
  ...
  rpmax = &res[nres];		/* end of alignment info */
