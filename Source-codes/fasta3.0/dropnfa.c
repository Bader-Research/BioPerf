...
/* $Name: fa34t25d2 $ - $Id: dropnfa.c,v 1.66 2004/11/19 15:28:26 wrp Exp $ */
...
#ifndef ALLOCN0
static char *verstr="3.47 Mar 2004";
#else
static char *verstr="3.47an0 Mar 2004";
#endif
...
extern int VFLOCAL_ALIGN(const unsigned char *, const unsigned char *,
			 const int, const int,
...
/* in the f_str version, the *res array is already allocated at 4*n0/3 */
  ...
  ALIGN(&aa0[L-1],&aa1[K-1],J-L+1,I-K+1,ppst->pam2[0],q,r,res,nres,f_str);
...
*/
   ...
   aln->min0 = min0-1; aln->min1 = min1-1;
...
int calcons_a(const unsigned char *aa0, unsigned char *aa0a, const int n0,
	      const unsigned char *aa1, const int n1,
	      int *res, int nres, int *nc,
	      struct a_struct *aln, struct pstruct pst,
