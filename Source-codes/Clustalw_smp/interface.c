...
void parse_params(Boolean xmenus)
{
	...
	if (!xmenus)
	{
		...
		fprintf(stdout, " SMP version 0.99-9 by Ognen Duzlevski, ognen@gene.pbi.nrc.ca\n");
		fprintf(stdout, " Plant Biotechnology Institute, National Research Council of Canada, Apr. 2002\n\n");
	}
