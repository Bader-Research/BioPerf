...
double neighborj_SK_tree(struct genome_struct *genomes, int num_genes, int num_genomes,
...
int neighborj_score_string(const char *constTree,
			   ...
			   int **status,int *best_so_far,env_t *const_env,
			   int *genes,
