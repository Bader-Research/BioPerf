/* $Id: all_sorting_reversals.h,v 1.23 2001/12/20 03:17:10 acs Exp $
...
enum comp_type { ORIENTED, SIMPLEHURDLE, SUPHURDLE, PROTNHURDLE, 
...
void find_double_superhurdles(List *uoc_list, ConnectedComponent *conn_comp, 
                              int nuoc, int *nhurdles);
