...
*   D.A. Bader, Y. Li, T. Li, V. Sachdeva, ``[BioPerf: A Benchmark Suite to Evaluate High-Performance Computer Architecture on Bioinformatics Applications](https://davidbader.net/publication/2005-byltls/),'' [ _The IEEE International Symposium on Workload Characterization (IISWC 2005)_](https://web.archive.org/web/20190506135227/http://www.iiswc.org/), Austin, TX, October 6-8, 2005\. [Powerpoint Slides](http://github.com/Bader-Research/BioPerf/BioPerf-IISWC2005)
